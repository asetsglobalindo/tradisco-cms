    ...
    <section>
      ...
      <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col w-full mt-5 space-y-4">
          ...
          <h4 className="pb-2 text-lg font-medium border-b border-primary/10">Review List</h4>
          <Controller
            control={form.control}
            name="small_text.en"
            render={({field, fieldState: {error}}) => (
                      ...
                      <div className="flex flex-col w-full space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            form.setValue(`body_review.${index}.title.id`, e.target.value);
                          }}
                        />
                        {error?.message ? (
                          <p className="text-xs font-medium text-destructive">{error?.message}</p>
                  ...
                  render={({field, fieldState: {error}}) => (
                    <div className="flex flex-col w-full space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          field.onChange(e.target.value);
                          form.setValue(`body_review.${index}.button_name.id`, e.target.value);
                        }}
                      />
                      {error?.message ? <p className="text-xs font-medium text-destructive">{error?.message}</p> : null}
                    </div>
          ...
          <h4 className="pb-2 text-lg font-medium border-b border-primary/10">Career opportunity</h4>
          <Controller
            control={form.control}
            name="small_text2.en"
            render={({field, fieldState: {error}}) => (
