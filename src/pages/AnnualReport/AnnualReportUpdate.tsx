...
const formSchema = z.object({
  ...
  body: z
    .object({
      ...
      text: z.object({
        en: z.string({required_error: "Field required"}).default(""),
        id: z.string({required_error: "Field required"}).default(""),
      }),
  ...
  type: z.string().default(CONTENT_TYPE.ANNUAL_REPORT),
                  ...
                  render={({field}) => {
                    return (
                      <ImageRepository
                        ...
                        limit={1}
                        mobileSize={false}
                        img_type={IMG_TYPE.ANNUAL_REPORT}
...
export default AnnualReportUpdate;
